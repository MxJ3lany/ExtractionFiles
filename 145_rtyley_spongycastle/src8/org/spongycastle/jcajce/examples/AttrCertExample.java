...
public class AttrCertExample
{
        ...
        throws Exception
    {
        ...
        X509AttributeCertificateHolder att = acBldr.build(new JcaContentSignerBuilder("SHA1WithRSA").setProvider("SC").build(caPrivKey));
        ...
        if (att.isSignatureValid(new JcaContentVerifierProviderBuilder().setProvider("SC").build(caPubKey)))
        {
