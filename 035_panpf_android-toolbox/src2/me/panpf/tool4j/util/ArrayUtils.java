...
public class ArrayUtils {
     ...
     *
     * @param objects   待移动的数组
     * @param headIndex 从此处开始，包括此处，取值范围0——objects.length-1
     * @param endIndex  从此处结束，包括此处，取值范围headIndex——objects.length-1
     * @param number    移动的位数，取值范围1——objects.length-1-endIndex
     */
     ...
     * @param headIndex 从此处开始，包括此处，取值范围0——objects.length-1
     * @param endIndex  从此处结束，包括此处，取值范围headIndex——objects.length-1
     * @param number    移动的位数，取值范围1——headIndex
     */
