...
public class ModClearAllRecents {
        ...
        try {
            ...
            XposedHelpers.findAndHookMethod(recentActivityClass, "onCreate", Bundle.class, new XC_MethodHook() {
                ...
                protected void afterHookedMethod(final MethodHookParam param) throws Throwable {
                    ...
                    FrameLayout vg = mRecentsActivity.getWindow().getDecorView()
                    ...
                    mForegroundProcessText = mRamUsageBar.findViewById(R.id.foregroundText);
                    mBackgroundProcessText = mRamUsageBar.findViewById(R.id.backgroundText);
            ...
            if (!Utils.isOxygenOsRom()) {
                XposedHelpers.findAndHookMethod(CLASS_TASK_STACK_VIEW, classLoader,
                        "updateStackActionButtonVisibility", new XC_MethodHook() {
                    @Override
    ...
    private static int getTaskCount(Object taskView) {
